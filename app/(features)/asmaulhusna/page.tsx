    ...
    <>
      ...
      <div className="flex flex-col min-h-screen relative">
        ...
        <div className="relative z-10 flex-1">
          {/* Header Section - dengan padding top untuk menghindari header */}
          <div className="pt-28">
          ...
          {/* Swiper Section - dengan spacing yang tepat */}
          ...
          {/* Additional Content Section - dengan container dan spacing yang konsisten */}
          <div className="container mx-auto px-4">
            <div className="space-y-8 md:space-y-12 pb-16 md:pb-24 mb-14">
              {/* Quick Navigation */}
      ...
      {/* Footer - dengan spacing yang tepat */}
